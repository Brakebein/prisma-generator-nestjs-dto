...
| `prismaClientImportPath = ""`                                    | Override import path of Prisma client. Defaults to either `@prisma/client` or a relative path base on your generator client output config (see [#73](https://github.com/Brakebein/prisma-generator-nestjs-dto/issues/73)).      |
